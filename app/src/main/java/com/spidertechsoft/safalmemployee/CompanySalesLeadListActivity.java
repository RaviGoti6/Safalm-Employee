...
public class CompanySalesLeadListActivity extends AppCompatActivity {
    ...
    int flag = 0;
    SafalmEmployee se;
    private String TAG = CompanySalesLeadListActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.company_sales_lead_list_activity);
        ...
        url = "http://10.0.2.2/safalm/company_sales_lead_list.php?emp_id=" + empid;
        // list.setAdapter(null);
        at = new CompanySalesLeadListActivity.Employee().execute();
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent i = new Intent(CompanySalesLeadListActivity.this, CompanySalesLeadDetailActivity.class);
    ...
    private class Employee extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(CompanySalesLeadListActivity.this);
        ...
        protected void onPostExecute(Void s) {
            ...
            adptr = new SimpleAdapter(CompanySalesLeadListActivity.this, leadList, R.layout.visited_lead_list_item, new String[]{TAG_VLID, TAG_VLNAME, TAG_VLADDRESS, TAG_VLCONTACT, TAG_VLDATE,"product"}, new int[]{R.id.txtVLLIid, R.id.txtVLLIname, R.id.txtVLLIaddress, R.id.txtVLLImobile, R.id.txtVLLIdate,R.id.txtVLLIproduct});
