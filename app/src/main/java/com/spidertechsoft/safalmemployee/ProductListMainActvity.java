...
public class ProductListMainActvity extends AppCompatActivity {
    ...
    SafalmEmployee se;
    private String TAG = ProductListMainActvity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.product_list_main_actvity);
        ...
        new ProductListMainActvity.Employee().execute();
    ...
    private class Employee extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(ProductListMainActvity.this);
        ...
        protected void onPostExecute(Void s) {
            ...
            ListAdapter adapter = new SimpleAdapter(ProductListMainActvity.this, product_list, R.layout.product_list_item, new String[]{TAG_PID, TAG_PNAME,TAG_PPRICE,TAG_PDETAIL}, new int[]{R.id.txtPLIid, R.id.txtPLIname,R.id.txtPLIprice,R.id.txtPLIdetail});
