...
public class VisitedLeadListActivity extends AppCompatActivity {
    ...
    int flag = 0;
    SafalmEmployee se;
    private String TAG = VisitedLeadListActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.visited_lead_list_activity);
        ...
        at = new VisitedLeadListActivity.Employee().execute();
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent i = new Intent(VisitedLeadListActivity.this, SelfVisitedLeadDetailActivity.class);
    ...
    private class Employee extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(VisitedLeadListActivity.this);
        ...
        protected void onPostExecute(Void s) {
            ...
            adptr = new SimpleAdapter(VisitedLeadListActivity.this, leadList, R.layout.visited_lead_list_item, new String[]{TAG_VLID, TAG_VLNAME, TAG_VLADDRESS, TAG_VLCONTACT, TAG_VLDATE,"product"}, new int[]{R.id.txtVLLIid, R.id.txtVLLIname, R.id.txtVLLIaddress, R.id.txtVLLImobile, R.id.txtVLLIdate,R.id.txtVLLIproduct});
